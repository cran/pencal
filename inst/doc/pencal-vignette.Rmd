...
Signorelli, M., Spitali, P., Al-Khalili Sgyziarto, C., The Mark-MD Consortium, Tsonaka, R. (in review). <!-- arXiv preprint: [arxiv number](arXiv link). --> NB: an arXiv preprint will be available soon!
...
<!-- The description of the method is available in an article [that you can read here](arXiv link). -->